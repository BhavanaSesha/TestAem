...
@Component(service = PdpPlantPagecreation.class, immediate = true)
public class PdpPlantPagecreationImpl implements PdpPlantPagecreation{
	...
	public void activate() {
		...
		try {
			...
			// creating a resource
			Resource pageResource = resourceResolver.getResource("/content/Project_O2Store/en/plants");
