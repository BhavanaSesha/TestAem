...
@Component(service = PdpFertilizersPageCreation.class, immediate = true)
public class PdpFertilizersPageCreationImpl implements PdpFertilizersPageCreation{
