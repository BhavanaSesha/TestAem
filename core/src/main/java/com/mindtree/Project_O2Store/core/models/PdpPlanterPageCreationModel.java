...
import com.mindtree.Project_O2Store.core.services.PdpPlanterPageCreation;


@Model(adaptables = Resource.class,defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
public class PdpPlanterPageCreationModel {
	
	@Inject
	String text;
	
	@OSGiService
	private PdpPlanterPageCreation service;
